 ...
 */
public class ChangeShifteDialog extends AbstractDialog {
    private RelativeLayout enter;
    private List<AllGroup> allGroups;
    private int choose;
    private WheelView wheelView;

    public ChangeShifteDialog(Context context, List<AllGroup> data, String content, View.OnClickListener onClickListener) {
        super(context);
        this.allGroups = data;
