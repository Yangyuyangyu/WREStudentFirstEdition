 ...
 */
public class PopupLeave extends PopupWindow {
    private View conentView;
    private OnPopupListenter listenter;

    public PopupLeave(final Activity context) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.popup_window_leava, null);
...
//        this.setAnimationStyle(R.style.AnimationPreview);
        ...
        TextView textView = (TextView) conentView.findViewById(R.id.tv_one);
        TextView textView1 = (TextView) conentView.findViewById(R.id.tv_two);
        TextView textView2 = (TextView) conentView.findViewById(R.id.tv_three);
